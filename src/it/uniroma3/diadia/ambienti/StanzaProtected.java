...
public abstract class StanzaProtected {
	...
	public void compattaAttrezziStanza(int iteratore) { // da chiamare appena eliminato un oggetto dalla  stanza ma prima di aggiornare il numero di attrezzi
